...
return [
    ...
    Sylius\Bundle\ThemeBundle\Context\ThemeContextInterface::class => ['test' => true, 'test_cached' => true],
    HWI\Bundle\OAuthBundle\HWIOAuthBundle::class => ['all' => true],
    Http\HttplugBundle\HttplugBundle::class => ['all' => true],
    Symfony\Bundle\MakerBundle\MakerBundle::class => ['all' => true, 'test_cached' => true],
];
