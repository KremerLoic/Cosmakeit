 ...
 */
final class Version20190928104406 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE favorite_shopuser (favorite_id INT NOT NULL, shopuser_id INT NOT NULL, INDEX IDX_F954077CAA17481D (favorite_id), INDEX IDX_F954077CDBFF1294 (shopuser_id), PRIMARY KEY(favorite_id, shopuser_id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sylius_shop_user DROP Favorite');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sylius_shop_user ADD Favorite LONGTEXT DEFAULT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:object)\'');
    }
}
